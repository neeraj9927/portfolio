      ...
      <div className="container">
        <div className="row text-center py-5">
            ...
            <div className="bg-light footer_input_box w-100 my-4 d-flex shadow" style={{borderRadius:'30px'}}>
                ...
                <button className='w-25 text-light' style={{borderRadius:'30px',border:'none',backgroundColor:'#47b2e4'}}>Subscibe</button>
            </div>
            </div>
        </div>
      </div>
      ...
      <section className="text-dark">
        <div className="row">
          <div className="col-md-6 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p><a className="text-dark text-decoration-none" href="#!">Phone: 9457386375</a></p>
            <p><a className="text-dark text-decoration-none" href="#!">Email: neerajkumarsbl1999@gmail.com</a></p>
          </div>
          ...
          <div className="col-md-6 col-lg-2 col-xl-2 mx-auto mt-3  text-center">
            ...
            <p>
              <a className="text-dark "href='#!'>Abouts</a>
            </p>
            <p>
              <a className="text-dark "href='#!'>Services</a>
            </p>
            <p>
          ...
          <div className="col-md-6 col-lg-3 col-xl-3 mx-auto mt-3  text-center">
            ...
            <p><a className="text-dark text-decoration-none" href="#!">Web Design</a></p>
            <p><a className="text-dark text-decoration-none" href="#!">Web Development</a></p>
            <p><a className="text-dark text-decoration-none" href="#!">Graphic Design</a></p>
            <p></p>
          </div>
